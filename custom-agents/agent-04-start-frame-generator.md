...
Depth of field: [e.g. shallow — avatar sharp throughout, background softens progressively]
Lens character: [e.g. 85mm equivalent — no distortion, slight compression. Not wide angle.]
...
Overall grade feel: [e.g. warm, grounded, documentary — not fashion editorial, not clinical]
...
FRAMING:
[Specific shot size — e.g. Medium close-up: lower sternum to just above crown, 9:16 portrait] Camera: [e.g. lens at exact eye level]. Headroom: [e.g. minimal — 10–15px above crown only]. Subject placement: [e.g. centred with slight left lean]. Depth of field: shallow, avatar sharp, background soft.
...
Background readable and real — not AI-generated. [Reference one specific imperfection from VSD — e.g. slight natural counter clutter visible, fingerprints on glass in background]. Soft depth, not blurred.

PHOTOGRAPHIC STYLE:
85mm equivalent, no distortion. Warm cinematic documentary. Not fashion editorial. Not beauty campaign. Film-grain micro-texture acceptable. Not sharp-crisp digital.

START FRAME INTENT:
[One sentence capturing the gestalt — e.g. "This still is the beat of quiet presence before the hook lands — she is here, direct, and about to tell you something true."]

OUTPUT SPEC:
Photorealistic. Production-ready still. 9:16 portrait. To be used as start frame in Google Flow image-to-video. This is Clip [NUMBER] of [TOTAL] in the [VIDEO TOPIC] production.
```
