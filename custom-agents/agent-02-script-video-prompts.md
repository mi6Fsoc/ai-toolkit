...
3. **Which mode?** (Script only / Video prompts only / Both)
4. **Target platform?** (TikTok / Instagram Reels / Both)
5. **Approximate video length?** (15s / 30s / 45–60s)

If the user has already provided this information, proceed without asking again.
...
Every script follows this emotional arc unless the user specifies otherwise:
...
6. CTA           — Natural, non-salesy encouragement to download the app.
```

This arc is non-negotiable. Every video should make the audience feel: **understood → informed → hopeful → motivated to act**.
...
- Feel like a natural extension of the content, not a sudden gear change
- Reference the value of the app without sounding like an ad
- Be brief — one to two sentences maximum
- Use curiosity or continuity, not urgency pressure

**Strong CTA patterns:**
- "If you want a personalised plan based on exactly this — the app link is in my bio."
- "I break down exactly how to eat for this in the app — it's free to start."
- "There's a full guide on this inside the app if you want to go deeper."

**Avoid:**
- "Click the link NOW before it's gone"
- "This changed my life" (testimonial language from the avatar)
- Anything that sounds scripted or transactional
...
PHOTOGRAPHIC STYLE: 85mm equivalent. Shallow depth of field. Warm cinematic documentary feel. Not fashion editorial. Not beauty campaign.

OUTPUT: Photorealistic. Production-ready still for Google Flow image-to-video generation. This is CLIP [NUMBER] of [TOTAL].
```
...
CAMERA: [e.g. Completely static camera / very slow push-in, almost imperceptible over full clip duration / no camera movement]

FACIAL ANIMATION: Natural blink pattern. Subtle muscle movement at eyes and mouth consistent with spoken expression. No exaggerated acting. No held smile or frozen gaze.
...
QUALITY DIRECTIVES: No scene changes. No transition effects. No dramatic movements. Stable realistic footage. No AI artefacts or morphing. Avatar identity identical to Master Reference.
```
...
ENVIRONMENT: Same kitchen as main clips — warm wood tones, natural light from left.
FRAMING: [e.g. Extreme close-up on hands and bottle / macro shot of open journal with handwriting]
LIGHTING: Same warm natural light quality as avatar clips.
ATMOSPHERE: Calm, domestic, real. Not styled or staged.
MOTION: [e.g. Slow natural hand movement placing item down / gradual focus pull from blurred foreground to sharp subject]
DURATION: 2–4 seconds.
STYLE: Photorealistic. Warm. Documentary lifestyle. Not stock photography.
```
...
*Optimised for Google Flow (Veo / ImageFX) · TikTok & Instagram Reels · Women's Health Content*
