...
* Scripts: full continuous text first, then clip breakdown. Explicitly label where the Science Fact, Home Remedy, and Functional Recipe are introduced.
