...
### ElevenLabs Settings Recommendations (General)
| Setting | Recommended Value |
|---|---|
| Stability | 0.55–0.70 (higher = more consistent, lower = more expressive) |
| Similarity Boost | 0.70–0.80 |
| Style | 0.10–0.25 (avoid high style — adds performance artefacts) |
| Speaker Boost | On |
